    ...
    internal new(mapFromType: Type, mapToType: Type, existingToType: Type) = 
        DuplicateMappingException
            (mapFromType, mapToType, existingToType, 
             ...
             sprintf "Attempted to map at least two concrete types (%s and %s) to the same interface (%s)." 
                 existingToType.FullName mapToType.FullName mapFromType.FullName, null)
